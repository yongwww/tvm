...
if(USE_CUDA AND USE_CUTLASS)
  ...
  if (CMAKE_CUDA_ARCHITECTURES MATCHES "([1-9][0-9][0-9]+)a?" AND CMAKE_MATCH_1 GREATER_EQUAL 100)
    list(APPEND TVM_CUTLASS_RUNTIME_SRCS src/runtime/contrib/cutlass/fp4_gemm.cu)
  endif()
